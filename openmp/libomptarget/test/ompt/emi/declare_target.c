...
int main() {
  ...
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_1:[0-9]+]], optype=ompt_target_data_alloc, src_addr=[[APTR_HOST_ADDR:0x[0-f]+]]
  ...
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_1]], optype=ompt_target_data_alloc, src_addr=[[APTR_HOST_ADDR]]
  ...
  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_begin
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_2:[0-9]+]], optype=ompt_target_data_transfer_to_device, src_addr=[[APTR_HOST_ADDR]]
  ...
  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_end
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_2]], optype=ompt_target_data_transfer_to_device, src_addr=[[APTR_HOST_ADDR]]
  // CHECK-SAME: src_device_num=[[HOST_NUM]], dest_addr=[[APTR_TARGET_ADDR]], dest_device_num=[[DEVICE_NUM]], bytes=8, codeptr_ra=[[TARGET_RETURN_ADDRESS_1]]{{[0-f][0-f]}}
  ...
  // CHECK-SAME: target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_3]], requested_num_teams=1
  ...
  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_begin
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_4:[0-9]+]], optype=ompt_target_data_transfer_from_device, src_addr=[[APTR_TARGET_ADDR]]
  ...
  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_end
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_4]], optype=ompt_target_data_transfer_from_device, src_addr=[[APTR_TARGET_ADDR]]
  // CHECK-SAME: src_device_num=[[DEVICE_NUM]], dest_addr=[[APTR_HOST_ADDR]], dest_device_num=[[HOST_NUM]], bytes=8, codeptr_ra=[[TARGET_RETURN_ADDRESS_1]]{{[0-f][0-f]}}

  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_begin
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_5:[0-9]+]], optype=ompt_target_data_delete, src_addr=[[APTR_HOST_ADDR]]
  // CHECK-SAME: src_device_num=[[HOST_NUM]], dest_addr=[[APTR_TARGET_ADDR]], dest_device_num=[[DEVICE_NUM]], bytes=8, codeptr_ra=[[TARGET_RETURN_ADDRESS_1]]{{[0-f][0-f]}}

  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_data_op_emi_end
  // CHECK-SAME: target_task_id=0, target_id=[[TARGET_ID_1]], host_op_id=[[HOST_OP_ID_5]], optype=ompt_target_data_delete, src_addr=[[APTR_HOST_ADDR]]
  // CHECK-SAME: src_device_num=[[HOST_NUM]], dest_addr=[[APTR_TARGET_ADDR]], dest_device_num=[[DEVICE_NUM]], bytes=8, codeptr_ra=[[TARGET_RETURN_ADDRESS_1]]{{[0-f][0-f]}}
